<template>
  <div class="flex-column center">
    ...
    <text class="h2">插件开发demo示例</text>
    <text class="h4 margin-top-40 margin-bottom-20">T0x13品类项目</text>
...
module.exports = {
  ...
  methods: {
    jumpTo() {
      ...
      //     });
      // });
      // const welcome = 'welcome to preview page!'
      // this.$MID.toast(welcome, 2)
      var url = 'weex.js'
