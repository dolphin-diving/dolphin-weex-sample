<template>
  <div class="wrapper">
    ...
    <div class="main">
      <dof-button text="执行goTo" type="primary" @dofButtonClicked="excuteClicked"></dof-button>
      <text class="display-block">
        const path = 'app.js' nativeService.goTo(path).then( (resp) => { this.result = resp } ).catch((error) => {
